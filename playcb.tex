...
\chapter[Primeiro capítulo e eu não sei o que tô fazendo]
{Primeiro capítulo\\ pfv, como assim}


\prologue{Nunca durma embaixo de um pé de jaca}
{ditado popular \cite{hamming}}


\section{Sessão}
Aqui vem uma explicação sobre o que diabos é esse capítulo e essa sessão.

\lstinputlisting[caption=Teste, style=customc]{src/ex1_PrimeiraJanela.cpp}
E aqui apareceu um código de teste da playcb, colorido usando gambiarra para deixá-lo bonito. áãÉêóÕÃ

\subsection{Eu preciso de sub-sessão?}
