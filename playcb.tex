...
\lstdefinestyle{customc}{
  ...
  otherkeywords={QUADRADO, RETANGULO, TRIANGULO, CIRCULO, ELIPSE, CIRCUNFERENCIA, PONTO, RETA, GRAFICO},           
  emph={
  		AbreImagem,
      AbreJanela,
      ApagaGrupo,
...
\dedication{À todos os alunos que queiram fazer trabalhos divertidos na primeira matéria de computação da UnB}
...
\prefaceauthor{Sinayra Pascoal Cotts Moreira}
\where{Brasília, Universidade de Brasília\\
Setembro, 2016}
