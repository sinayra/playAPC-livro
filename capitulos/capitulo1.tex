...
\lstinputlisting[caption=Código fonte do quadrado inscrito, style=customc, label=lst:cap1_ex4]{src/ex21_inscrito.cpp}
...
\subsection*{Exercício \ref{ex:cap01_ex9}}
\begin{figure}[ht]
...
\lstinputlisting[caption=Código fonte do ponto dentro ou fora da circunferência, style=customc, label=lst:cap1_ex9]{src/ex22_inout.cpp}
...
\subsection*{Exercício \ref{ex:cap01_ex10}}
\begin{figure}[ht]
...
\lstinputlisting[caption=Código fonte da classificação de triângulos, style=customc, label=lst:cap1_ex10]{src/ex23_exibetriangulo.cpp}
